...
const ChatBot = () => {
  ...
  const getResponse = async (message) => {
    console.log(navigations[id].data);
    const subjectData = navigations[id - 1].data;
    await axios
      .post("http://localhost:3000/chatbot", {
        message:
          subjectData +
          `Assume that you are a Teaching Assistant for the subject ${
            navigations[id - 1].name
          } and I have sent you all the details for the subject above, answer the questions for students related to the data given to you and if you know topics related to them you can answer that yourself as well for the subject given to you, if students greet you, you can also just greet them` +
          message,
      })
      .then((res) => {
