...
const create = (quiz) => {
  const prompt = `based on the provided cognitive behavioural therapy questionnaire generate an accurate medical report on my mental health in less than 200 words. Also tell me my medical problem. and categorize the state of the mental patient into three categories, Normal, Mild and Severe, and if it is severe then tell the patient to contact any nearby doctor - This is mandatory and it should be on the first line of the report ${quiz}`;
  return prompt;
};
